...
public final class BridgeKernel {
    public static final Set<String> OPERATIONS=Set.of("goto","gather","craft","eat","container_transfer","set_base","deposit","say","register_home","capture_home","repair_home","register_farm","tend_farm","mine_opportunity","place","move_items","toms_diag");
