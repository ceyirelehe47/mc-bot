...
| 套件 | 门槛 | 实测 | 备注 |
|---|---|---|---|
| JUnit dev round1(供给原样) | — | 437 / 5 fail | 5 处源码契约断言失配(拆行), 预审 subagent 预测逐一命中 |
| JUnit dev round2(修正后) | ≥437/0 | **437 / 0 / 0** | junit-postfix |
| JUnit dev round3(--rerun-tasks) | ≥437/0 | **437 / 0 / 0** | 早轮已证 |
| JUnit clean replay | ≥437/0 | **437 / 0** | replay-postfix.log |
